...
# ov16_gabon_k_3_mounted_response_hyp_mfp_5 - 100% of ppl can mount response
simulatedGabonData_elisa <- processRCSFiles("ov16_gabon_k_3_mounted_response_hyp_mfp_5/", verbose=FALSE)
...
simulatedGabonData_elisa_sero_no_inf_k3 <- processRCSFiles("ov16_gabon_seroreversion_3_k_3/", verbose=FALSE)

simulatedGabonData_elisa_sero_no_inf_k3$abr_vs_mf_prev

data.frame(a=simulatedGabonData_elisa_sero_no_inf_k3$abr_vals, b=simulatedGabonData_elisa_sero_no_inf_k3$mf_prev) %>% group_by(a) %>% summarise(mean(b), n(), .groups="drop")

summarizeSimulatedGabon_elisa_sero_no_inf_k3 <- simulatedGabonData_elisa_sero_no_inf_k3$allOutputs
...
make_adjusted_plot <- function(df1, df2, compValLabel, compVal1, compVal2, df3, label="a)", desc="") {
  ...
  plotLineTypes <- c("L3 exposure"="dashed", "L4-L5 moult"="dashed", "Any worm"="dashed", "Mating worm pair"="dotted", "Mating worm pair with any mf"="dotted", "Mating worm pair with detectable mf"="dotted")
...
adjust_comp_100_mount_k2_1 <- make_adjusted_plot(summarized_gabon_rdt_elisa, simulation_summary_elisa_100_mount, "Diagnostic Adjustment", "No", "Yes", simulation_summary_elisa_100_mount) + ylim(0,51)

adjust_comp_100_mount_k2_2 <- make_adjusted_plot(summarized_gabon_rdt_elisa, simulation_summary_sens_spec_elisa_100_mount, "Diagnostic Adjustment", "No", "Yes", simulation_summary_sens_spec_elisa_100_mount) + ylim(0,51)
...
trig_sero_k2_1 <- make_adjusted_plot(summarized_gabon_rdt_elisa, simulation_summary_sens_spec_elisa_sero_trigger, "Seroreversion", "Yes", "No", simulation_summary_sens_spec_elisa_sero_trigger, "b)", "w/ Seroreversion")

inf_sero_k2_1 <- make_adjusted_plot(summarized_gabon_rdt_elisa, simulation_summary_sens_spec_elisa_sero_no_inf, "Seroreversion", "Yes", "No", simulation_summary_sens_spec_elisa_k2, "c)", "w/ Seroreversion")

arranged_seroreversion_graph <- ((adjust_comp_100_mount_k2_2 + ylim(0, 21) + theme(legend.direction = "horizontal") + guides(alpha="none")) | (trig_sero_k2_1 + ylim(0, 21) + theme(legend.direction = "horizontal", axis.title.y=element_blank()) + guides(alpha="none")) | (inf_sero_k2_1 + ylim(0, 21) + theme(legend.direction = "horizontal", axis.title.y=element_blank()) + guides(alpha="none"))) + plot_layout(guides = "collect") + plot_annotation(
  theme = theme(legend.position = "bottom",
                legend.direction = "horizontal")
)
...
make_adjusted_plot(summarized_gabon_rdt_elisa, simulation_summary_sens_spec_elisa_100_mount, "Diagnostic Adjustment", "No", "Yes", simulation_summary_sens_spec_elisa_100_mount)
```
