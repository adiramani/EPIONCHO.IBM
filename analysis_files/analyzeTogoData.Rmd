...
for(mfp in mfp_vals) {
  ...
  tmp <- processRCSFiles(paste("/Volumes/Beep/togo_mfp_tuning_k3_70_final/", fileNameMFP,"/",sep=""), verbose=FALSE, onlyCalcMFP=TRUE)
...
final_plot <- (all_plots[["70"]] / all_plots[["85"]]) + plot_layout(axis_titles="collect")

ggsave(paste("../images/", "final_gamma_abr_dist_", kval, "_mfp_70_85.png", sep=""), final_plot, width=7000, height = 4000, units="px", dpi=600)
