...
if (use_onchosim) {
  ...
  version_to_use = paste0(version_to_use, "_onchosim")
}
...
if ("sens_spec_list_from_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  sens_spec_from_dist <- readRDS(paste0("images/images_", version_to_use, "/sens_spec_list_from_dist.rds"))
}
...
if ("k2_100_mount_sim_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  simulation_summary_dist_sens_spec_rdt_100_mount <- readRDS(paste0("images/images_", version_to_use, "/k2_100_mount_sim_summary_adjusted_with_dist.rds"))
} else {
...
if ("k2_sero_trigger_sim_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  simulation_summary_dist_sens_spec_rdt_sero_trigger <- readRDS(paste0("images/images_", version_to_use, "/k2_sero_trigger_sim_summary_adjusted_with_dist.rds"))
} else {
...
if ("k2_sero_no_inf_sim_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  simulation_summary_dist_sens_spec_rdt_sero_no_inf <- readRDS(paste0("images/images_", version_to_use, "/k2_sero_no_inf_sim_summary_adjusted_with_dist.rds"))
} else {
...
if ("resids_k2_df.rds" %in% list.files(paste0("images/images_", version_to_use, "/"))) {
  resids_k2 <- readRDS(paste0("images/images_", version_to_use, "/resids_k2_df.rds"))
} else {
...
if (use_onchosim) {
  normalized_mse_plot <- process_resids(
    rbind(
      ...
      readRDS(paste0("images/images_", sub("_onchosim", "", version_to_use), "/resids_k2_df.rds")) %>% mutate(Descriptor = paste0("EPIONCHO", Descriptor))
    ),
...
if ("resids_k3_df.rds" %in% list.files(paste0("images/images_", version_to_use, "/"))) {
  resids_k3 <- readRDS(paste0("images/images_", version_to_use, "/resids_k2_df.rds"))
} else {
...
if (use_onchosim) {
  tmp_list <- list(
    readRDS(paste0("images/images_", sub("_onchosim", "", version_to_use), "/k2_100_mount_sim_summary_adjusted_with_dist.rds"))
  )
  ...
  tmp_list <- list(
    readRDS(paste0("images/images_", sub("_onchosim", "", version_to_use), "/k2_sero_trigger_sim_summary_adjusted_with_dist.rds"))
  )
  ...
  tmp_list <- list(
    readRDS(paste0("images/images_", sub("_onchosim", "", version_to_use), "/k2_sero_no_inf_sim_summary_adjusted_with_dist.rds"))
  )
