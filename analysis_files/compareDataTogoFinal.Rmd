...
if (use_oti_100) {
  ...
  version_to_use = paste0(version_to_use, "_oti_100")
}
...
sens_plot <- ggplot() +
  ...
  # geom_histogram(aes(x=sens, color="sensitivity data count"), fill="white", binwidth = 0.025, boundary=0) +
  # geom_line(aes(x=seq(0, 1, 0.0001), y=beta_params_sens[[1]], color="Beta Density using data")) +
  ...
  #     ~ . / sens_scale,
  #     breaks = c(
  #       seq(0, max(beta_params_sens[[1]]), 1),
  #       5
  #     ),
  #     name = "Beta Density"
  #   )
...
spec_plot <- ggplot() +
  ...
  # geom_histogram(aes(x=spec, color="specificity data count"), fill="white", binwidth = 0.01, boundary=0) +
  # geom_line(aes(x=seq(0, 1, 0.0001), y=beta_params_spec[[1]], color="Beta Density using data")) +
    ...
    for(pick in all_places_to_pick) {
      ...
      if (prefecture == "oti") {
        ...
        if (use_oti_100) {
          ...
          tmp_oti_100 <- readRDS(
            paste("data/", prefecture_folder, folder_to_use, "togo_", prefecture_folder, "_100_mount_data", pick, ".RDS", sep="")
          )$allOutputs %>% 
            mutate(
              run_num = run_num * 3, 
...
combine_oti_100_base <- function(version) {
  
}

num_sens_specs <- 1500
sens_spec_from_dist <- c()
if ("sens_spec_list_from_dist_togo.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  sens_spec_from_dist <- readRDS(paste0("images/images_", version_to_use, "/sens_spec_list_from_dist_togo.rds"))
}
...
if ("oti_k3_100_mount_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  oti_k3_100_mount_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/oti_k3_100_mount_summary_adjusted_with_dist.rds"))
} else {
...
if ("keran_k3_100_mount_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  keran_k3_100_mount_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/keran_k3_100_mount_summary_adjusted_with_dist.rds"))
} else {
...
if ("bassar_k3_100_mount_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  bassar_k3_100_mount_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/bassar_k3_100_mount_summary_adjusted_with_dist.rds"))
} else {
...
if ("comb_k3_100_mount_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  comb_k3_100_mount_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/comb_k3_100_mount_summary_adjusted_with_dist.rds"))
} else {
...
if ("oti_k3_instant_sero_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  oti_k3_instant_seroreversion_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/oti_k3_instant_sero_summary_adjusted_with_dist.rds"))
} else {
...
if ("keran_k3_instant_sero_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  keran_k3_instant_seroreversion_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/keran_k3_instant_sero_summary_adjusted_with_dist.rds"))
} else {
...
if ("bassar_k3_instant_sero_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  bassar_k3_instant_seroreversion_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/bassar_k3_instant_sero_summary_adjusted_with_dist.rds"))
} else {
...
if ("comb_k3_instant_sero_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  comb_k3_instant_seroreversion_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/comb_k3_instant_sero_summary_adjusted_with_dist.rds"))
} else {
...
if ("oti_k3_gradual_sero_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  oti_k3_gradual_seroreversion_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/oti_k3_gradual_sero_summary_adjusted_with_dist.rds"))
} else {
...
if ("keran_k3_gradual_sero_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  keran_k3_gradual_seroreversion_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/keran_k3_gradual_sero_summary_adjusted_with_dist.rds"))
} else {
...
if ("bassar_k3_gradual_sero_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  bassar_k3_gradual_seroreversion_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/bassar_k3_gradual_sero_summary_adjusted_with_dist.rds"))
} else {
...
if ("comb_k3_gradual_sero_summary_adjusted_with_dist.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  comb_k3_gradual_seroreversion_simulation_summary_combined_dist_sens_spec <- readRDS(paste0("images/images_", version_to_use, "/comb_k3_gradual_sero_summary_adjusted_with_dist.rds"))
} else {
...
if ("raw_resids_pref.csv" %in% list.files(paste0("images/images_", version_to_use)) | !use_calc_lsr_pref) {
  resids_pref <- read.csv(paste0("images/images_", version_to_use, "/raw_resids_pref.csv"))
} else {
  resids_pref = c()
...
if ("togo_combined_best_fit_data.rds" %in% list.files(paste0("images/images_", version_to_use))) {
  best_fit_vc <- readRDS(paste("images/images_", version_to_use, "/togo_combined_best_fit_data.rds", sep=""))
} else {
  best_fit_vc <- list()
  ...
  saveRDS(best_fit_vc, paste("images/images_", run_version, "/togo_combined_best_fit_data.rds", sep=""))
}
  ...
  new_result <- rbind(
      ...
      custom_calc_resid(togoOv16Data %>% filter(age_groups > 0),
                        data_manip_resid(best_fit_vc_finite_seroreversion %>% filter(), sens_spec) %>% 
                          left_join(
                            data_manip_resid(best_fit_vc_100_mount, sens_spec) %>% dplyr::select(-vctr.ctrl.eff), by=c("run_num", "Hypothesis", "age_groups")
                          ) %>%
                          mutate(
                            ov16_prev = (ov16_prev.x + ov16_prev.y) / 2
                          ) %>%
                          dplyr::select(-ov16_prev.x, ov16_prev.y), 
...
new_result <- rbind(
    ...
    custom_calc_resid(togoOv16Data %>% filter(age_groups > 0),
                      data_manip_resid(best_fit_vc_finite_seroreversion %>% filter(), c(-1, -1)) %>% 
                        left_join(
                          data_manip_resid(best_fit_vc_100_mount, c(-1, -1)) %>% dplyr::select(-vctr.ctrl.eff), by=c("run_num", "Hypothesis", "age_groups")
                        ) %>%
                        mutate(
                          ov16_prev = (ov16_prev.x + ov16_prev.y) / 2
                        ) %>%
